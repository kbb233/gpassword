...
public class GraphicalPasswordActivity extends AppCompatActivity {
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedImageViews.size() == 4) {
                    ...
                    Toast.makeText(GraphicalPasswordActivity.this, "Please choose 4 images", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onClick(View v) {
                        ...
                        if (selectedImageView.isSelected()) {
                            ...
                            if (selectedImageViews.size() < 4) {
                                ...
                                ImageView clonedImageView = new ImageView(GraphicalPasswordActivity.this);
                                ...
                                Toast.makeText(GraphicalPasswordActivity.this, "You can only select 4 images", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
