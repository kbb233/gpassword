...
public class GraphicalPasswordActivity_Recovery extends AppCompatActivity {
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedImageViews.size() == 4) {
                    ...
                    Toast.makeText(GraphicalPasswordActivity_Recovery.this, "Please choose 4 images", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onClick(View v) {
                        ...
                        if (selectedImageView.isSelected()) {
                            ...
                            if (selectedImageViews.size() < 4) {
                                ...
                                ImageView clonedImageView = new ImageView(GraphicalPasswordActivity_Recovery.this);
                                ...
                                Toast.makeText(GraphicalPasswordActivity_Recovery.this, "You can only select 4 images", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
